...
# Themes
const GOFUS_POPUP_MENU_THEME = preload("res://assets/popup_menu_theme.tres")
const NPC_DIALOG_THEME = preload("res://assets/npc_dialog_theme.tres")
# Scenes
...
func open_npc_popup_menu(npc_interaction_data: Array[Dictionary]):
	...
	gofus_popup_menu.initialize(npc_interaction_data)
