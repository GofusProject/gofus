...
var ground_level: int = 7   # Uniform ground level (slope ignored)

@export var draw_test: Node2D
@export var pathfinding_handler: PathfindingHandler
...
func create_grid(p_grid_size: Vector2i) -> void:
	...
	var max_col: int = p_grid_size.x - 1
	var cell_count = p_grid_size.x * p_grid_size.y
...
func pathfinding_handler_setup_astar_2d_grid():
	pass


func pathfinding_handler_get_grid_path():
	pass